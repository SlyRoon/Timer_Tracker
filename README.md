...
Зараз завершено **Етап 2 — Backend domain foundation**.

Стартовий scaffold і backend domain foundation створено:
...
- repository layer ще не реалізовано;
- service layer ще не реалізовано;
- Project CRUD ще не реалізовано;
- timer start/stop ще не реалізовано;
- today entries logic ще не реалізовано;
- task autocomplete ще не реалізовано;
- reports і CSV export ще не реалізовано;
