...
Зараз завершено **Етап 4 — Service layer**.

Стартовий scaffold, backend domain foundation, repository layer і service layer створено:
...
- controllers, validators і feature routes ще не реалізовано;
