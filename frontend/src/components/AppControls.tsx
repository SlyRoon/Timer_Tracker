    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-end sm:justify-end">
      <div>
        ...
        <div
          ...
          className="mt-2 flex rounded-md border border-zinc-200 bg-white p-1"
      ...
      <label className="block min-w-[160px]" htmlFor="accent-theme">
        ...
        <select
          className="mt-2 w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm font-semibold text-zinc-700 outline-none transition focus:border-[rgb(var(--color-accent))] focus:ring-2 focus:ring-[rgb(var(--color-accent-soft))]"
          id="accent-theme"
          onChange={(event) =>
