...
- після важливого завершеного етапу оновити `PROMPTS_LOG.md`;
- наприкінці коротко підсумувати зміни, перевірки і наступний логічний крок.
...
### 10.1. Що логувати
- Логуються тільки ключові етапи.
- Не ведеться мікролог кожної дрібної правки.
- Після кожного важливого етапу `PROMPTS_LOG.md` оновлюється автоматично, якщо є доступ до файлів.
...
- Якщо prompt довгий, збережи condensed version з ключовими вимогами.
...
8. Після змін автоматично онови `PROMPTS_LOG.md`.
9. Наприкінці дай короткий звіт і наступний логічний крок.
